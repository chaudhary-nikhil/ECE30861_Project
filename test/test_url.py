...
class TestDetermineCategory:
    @pytest.mark.parametrize("url,expected_category", [
        ...
        ("https://huggingface.co/datasets/microsoft/DialoGPT-medium", UrlCategory.DATASET),
        ("https://huggingface.co/datasets/openai/webgpt_comparisons", UrlCategory.DATASET),
    ...
    def test_regex_patterns_edge_cases(self):
        ...
        assert determine_category("https://huggingface.co/datasets/test123") == UrlCategory.DATASET
        assert determine_category("https://github.com/user123/repo456") == UrlCategory.CODE
...
class TestUrl:
    ...
    def test_url_str_representation(self):
        url = Url("https://huggingface.co/datasets/squad", UrlCategory.DATASET)
        expected_str = "https://huggingface.co/datasets/squad Category: UrlCategory.DATASET"
...
class TestIntegration:
    ...
    @pytest.mark.parametrize("url,expected_category,should_print_error", [
    ...
    @patch('sys.stdout', new_callable=StringIO)
    def test_end_to_end_url_processing(self, mock_stdout, url, expected_category, should_print_error):
        url_obj = Url(url)
